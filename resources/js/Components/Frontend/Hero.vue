...
<script>
    ...
    data() {
        return {
        imagePath: 'public/img/hero.jpg', // Relative to the 'public' directory
        };
    },
    };
</script>
    ...
    >
      <div class="flex flex-col md:flex-row items-center h-full pt-8">
        <div class="flex-1 flex flex-col items-center lg:items-start">
          <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Shakil! 👋</p>
          <h1
            class="
              text-4xl
              leading-[44px]
            ...
            <div class="flex items-center mb-6">
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://facebook.com/shibleshakil"
              >
                <svg
                  width="8"
                  height="16"
              ...
              <a
                class="
                  ...
                  sm:mr-4
                "
                href="https://www.linkedin.com/in/shibleshakil/"
              >
                <svg
                  width="14"
                  height="14"
